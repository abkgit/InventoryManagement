...
/**
 * {@link ContentProvider} for Inventory Management app.
 */
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventorymanagement/products"
        ...
        // The content URI of the form "content://com.example.android.inventorymanagement/products/#"
        // will map to the integer code {@link #PRODUCT_ID}. This URI is used to provide access to
        // ONE single row of the products table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.example.android.inventorymanagement/products/3" matches, but
        // "content://com.example.android.inventorymanagement/products" (without a number at the
        // end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // "content://com.example.android.inventorymanagement/products/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // If the available quantity is provided, check that it's greater than or equal to 0
        Integer quantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
        if (quantity != null && quantity < 0) {
            throw new IllegalArgumentException("Product requires valid quantity value");
        }

        // Check that the supplier's email address is not null
        ...
        // No need to check the photo URI, any value is valid (including null).
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection,
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_PRICE)) {
            // Check that the price is greater than or equal to $0.00
            Double price = values.getAsDouble(ProductEntry.COLUMN_PRODUCT_PRICE);
            if (price != null && price < 0.00) {
                throw new IllegalArgumentException("Product requires valid price value");
            }
        ...
        // check that the available quantity value is valid.
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_QUANTITY)) {
            // Check that the available quantity is greater than or equal to 0
            Integer quantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
            if (quantity != null && quantity < 0) {
                throw new IllegalArgumentException("Product requires valid quantity value");
            }
        ...
        // check that the supplier's email address value is not null.
